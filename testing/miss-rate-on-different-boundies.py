...
def runTests(start, end, boundry=16):
    ...
    for size in range(start, end):
        cmd = ["valgrind", "--tool=callgrind", "--cache-sim=yes", "--separate-threads=yes", "../jacobi", str(size), str(size), str(threads), str(eps), str(boundry)]
